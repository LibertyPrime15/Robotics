...
//3 inches --93.567
    ...
    {
        distRemain =((totField - (distGone - 280.7)) * (11.97/1120)) * (-1);
        telemetry.addData("Value",robot.front_left.getCurrentPosition());
        telemetry.addData("distRemain",distRemain);
        telemetry.update();
...
//            turnAngle(-90);
        ...
        distGone = robot.front_left.getCurrentPosition();
        robot.resetEncoder();
        return distGone;
    }
    //--------------------------------------------------------------------------------------------------
