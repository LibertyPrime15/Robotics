package org.firstinspires.ftc.Colee.leagueCode.red;
...
@Autonomous(name = "redLeagueBlockAndPlate", group = "redLeague")
//@Disabled
public class redLeagueBlockAndPlate extends LinearOpMode
{
...
//Power is the power that we want to move at; it should be between 0 and 1. Making this value negative will put the bot into a loop that goes on forever
	...
	private void blockPositionThree()
	{
		...
		robot.ungrabPlate();
		moveDistanceAtAngle(1.5, -90, 0.8);
		stop();
	}
	//--------------------------------------------------------------------------------------------------
